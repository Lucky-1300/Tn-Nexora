...
export default function PerformancePricing() {
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#0a0f1c]">
      <section className="bg-[radial-gradient(circle_at_top,_rgba(99,102,241,0.18),_transparent_40%),linear-gradient(180deg,rgba(16,21,34,0.95),rgba(10,15,28,1))]">
      ...
      <section id="plans" className="mx-auto w-full max-w-[1600px] px-4 pb-8 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className={`relative flex flex-col rounded-3xl border bg-white/5 p-10 shadow-xl backdrop-blur transition duration-300 hover:-translate-y-1 hover:border-indigo-400/60 hover:shadow-indigo-500/10 ${
                plan.highlight
            ...
            >
              ...
              <div className="mt-6 rounded-2xl border border-white/10 bg-[#11182a] p-7 text-center">
                <div className="text-4xl font-extrabold text-indigo-300">{plan.price}</div>
