...
const teamMembers = [
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/ishani-rastogi-602512375?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  ...
  },
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/utkarsh-jaiswal-101401317?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  ...
  },
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/shaikh-aafiya-2442a8297?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  ...
  },
  {
    ...
    linkedin: "linkedin.com/in/sankalp-srivastava-813688240",
    desc: "Sankalp Srivastava leads our marketing team with a strong focus on growth, branding, and performance-driven strategies. He specializes in digital marketing, lead generation, and creating impactful campaigns that drive real business results. With a data-driven approach and innovative mindset, he plays a key role in scaling our brand presence.",
  },
];
...
export default function Team() {
  ...
  return (
    <section
      id="team"
      className={`py-5 px-4 transition duration-300 ${isDark ? "bg-[#0a0f1c] text-white" : "bg-white text-gray-900"}`}
    >
      {/* Heading */}
      <div className="text-center mb-12">
        <h2
          className={`text-3xl md:text-4xl font-bold transition duration-300 ${isDark ? "text-white" : "text-gray-900"}`}
        >
          Meet Our Team
        </h2>
        <p
          className={`mt-2 transition duration-300 ${isDark ? "text-white/70" : "text-gray-600"}`}
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-7xl mx-auto">
        {teamMembers.map((member, index) => (
          ...
          <div
           ...
           ${index === 4 ? "md:col-start-2 md:col-span-2 flex justify-center" : ""}
           ${
           isDark
          ...
          >
            ...
            <div className="p-5">
              <h3
                className={`text-lg font-bold transition duration-300 ${isDark ? "text-white" : "text-gray-900"}`}
              >
                {member.name}
              </h3>
              ...
              <p className={`text-sm mt-1 transition duration-300`}>
                <span
                  className={`font-semibold ${isDark ? "text-indigo-400" : "text-orange-600"}`}
                >
                  {member.role}
                </span>
              </p>
              ...
              <p
                className={`text-xs mt-2 leading-relaxed transition duration-300 ${isDark ? "text-white/60" : "text-gray-600"}`}
              >
                {member.desc}
              </p>
