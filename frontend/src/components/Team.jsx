...
export default function Team() {
  ...
  return (
    <section
      id="team"
      className={`py-8 px-4 transition duration-300 ${
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto">
        {teamMembers.map((member, index) => (
          <div
            ...
            } border backdrop-blur-lg shadow-lg hover:-translate-y-2 h-full min-h-[430px]`}
          >
            <>
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div
                  className={`mt-auto mt-5 h-[3px] opacity-80 w-0 rounded-full transition-all duration-300
                  ${
                    isDark
