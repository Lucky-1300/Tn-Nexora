...
//               className="relative max-w-[260px] w-full bg-white/5 backdrop-blur border border-white/10 rounded-2xl shadow-lg flex flex-col items-center text-center p-5 cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:border-transparent hover:bg-gradient-to-br hover:from-indigo-500/20 hover:to-blue-500/10 group min-h-[200px] justify-center"
//             >
//               {/* Gradient Glow Border on Hover */}
//               <span className="pointer-events-none absolute inset-0 rounded-2xl z-0 opacity-0 group-hover:opacity-100 transition duration-300 bg-gradient-to-r from-indigo-500 via-blue-400 to-purple-500 blur-[6px]"></span>
//               <div className="relative z-10 flex flex-col items-center">
//                 <div className="mb-3 flex items-center justify-center rounded-full bg-black/10 p-2">
//                   {/* Smaller icon */}
//                   {React.cloneElement(service.icon, { className: 'w-6 h-6 ' + service.icon.props.className })}
//                 </div>
//                 <h3 className="text-base font-bold text-white mb-1 leading-tight">
//                   {service.title}
//                 </h3>
//                 <p className="text-xs text-white/70 mb-0 leading-snug">
//                   {service.desc}
//                 </p>
//               </div>
//             </div>
